...
const CreateOrder = () => {
    ...
    const order = () => {
        ...
        if (name === "" || phoneNumber === null || city === "" || street === "" || zipCode === null || detailedAddress === "") {
            ...
            <form>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" placeholder="" value={name} onChange={handleOnChangeName} />
                    </div>
                ...
                <div class="form-check text-start my-0.5"></div>
                <button class="w-100 btn btn-dark btn-primary btn-lg" onClick={order}>Order</button>
